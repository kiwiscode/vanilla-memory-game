  ...
  document.querySelectorAll(".card").forEach((card) => {
    card.addEventListener("click", () => {
      ...
      if (pickedCards.length === 2) {
        document.querySelector("#memory-board").style.pointerEvents = "none";

        setTimeout(() => {
          document.querySelector("#memory-board").style.pointerEvents = "auto";
        }, 1300);
...
const pickMe = document.getElementById("try-preventDefault");

pickMe.addEventListener("click", (e) => {
  e.preventDefault();
});
